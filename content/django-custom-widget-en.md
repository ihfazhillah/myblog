...
![result]({filename}media/custom-widget-2.png)
...
![toggle off]({filename}media/custom-widget-3.png)
![toggle on]({filename}media/custom-widget-4.png)
...
![select2]({filename}media/custom-widget-5.png)
...
![select multiple]({filename}media/custom-widget-6.png)

But, if you got a page like following, the `customselect2.js` asset not loaded properly.

![customselect2.js not loaded]({filename}media/custom-widget-7.png)
...
![dropzone]({filename}media/custom-widget-8)
