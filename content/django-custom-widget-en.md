...
![result]({static}media/custom-widget-2.png)
...
![toggle off]({static}media/custom-widget-3.png)
![toggle on]({static}media/custom-widget-4.png)
...
![select2]({static}media/custom-widget-5.png)
...
![select multiple]({static}media/custom-widget-6.png)

But, if you got a page like following, the `customselect2.js` asset not loaded properly.

![customselect2.js not loaded]({static}media/custom-widget-7.png)
...
![dropzone]({static}media/custom-widget-8)
